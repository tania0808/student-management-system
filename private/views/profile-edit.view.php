            ...
            <form method="post" enctype="multipart/form-data">
                <div class="d-flex justify-content-center">
                    <div class="text-center mb-3 mb-sm-0">
                        ...
                        <img class="border rounded-circle" src="<?=$image ?>" alt="logo" style="width: 150px;">
                        <?php if (Auth::access('reception') || Auth::i_own_content($user)): ?>
                            <input class="form-control form-control-sm w-75 mx-auto mt-3" type="file" name="image">
                        <?php endif; ?>
                    </div>
                    <div class="mx-auto w-75">
                        ...
                        <div class="mb-3">
                            <select value="<?= get_var('rank') ?>" name="rank" id="rank" class="form-select">
                                <option <?= get_select('rank', $user->rank) ?>
                                        value="<?= $user->rank ?>"><?= ucfirst($user->rank) ?></option>
                        ...
                        <div class="mb-3">
                            <input value="<?= get_var('password') ?>" type="password" class="form-control" id="password"
                        ...
                        <div class="mb-3">
                            <input value="<?= get_var('password2') ?>" type="password" class="form-control"
                                   id="password2"
                        ...
                        <div>
                            <a  class="btn btn-danger" href="<?= ROOT ?>/profile/<?= $user->student_id ?>">
                                Back to profile
                            </a>
